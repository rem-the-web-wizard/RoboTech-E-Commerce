...
!(function () {
        ...
        if (t) {
          ...
          for (; s--; ) {
            ...
            if (a) {
              ...
              (n && 0 !== a.length) ||
                (delete r[t],
                ea(e, a.fakeName || t, a.nativeHandler, a.capture));
            }
          }
        } else
          pe(r, (t, n) => {
  ...
  const La = (e) => {
    ...
    oi = dr,
    ri = (e) => (
      oi(e) && (e = e.parentNode), ni(e) && e.hasAttribute("data-mce-caret")
    ),
    si = (e) => oi(e) && ei(e.data),
    ai = (e) => ri(e) || si(e),
    ...
    li = (e) => {
      ...
      return (
        !!dr(t) &&
        (t.data.charAt(e.offset()) === Ja ||
          (e.isAtStart() && si(t.previousSibling)))
      );
    },
    di = (e) => {
      const t = e.container();
      return (
        !!dr(t) &&
        (t.data.charAt(e.offset() - 1) === Ja ||
          (e.isAtEnd() && si(t.nextSibling)))
      );
    },
    ...
    vi = (e, t) => {
      ...
      return (
        e.bottom - n < t.top ||
        (!(e.top > t.bottom) && bi(t.top - e.bottom, e, t))
      );
    },
    yi = (e, t) =>
      e.top > t.bottom || (!(e.bottom < t.top) && bi(t.bottom - e.top, e, t)),
    Ci = (e, t, n) => {
    ...
    Bi = ai,
    Pi = (e) =>
      !Bi(e) && (Ri(e) ? !Ai(e.parentNode) : Ti(e) || Ni(e) || Oi(e) || Di(e)),
    Di = (e) =>
      !((e) => er(e) && "true" === e.getAttribute("unselectable"))(e) && Si(e),
    Li = (e, t) =>
      Pi(e) &&
      ((e, t) => {
        ...
        n ||
          (n = ((e) => {
            const t = [],
              ...
              o = (e, t) => {
                ...
                if (t < e.data.length) {
                  ...
                  if (
                    ki(e.data[t - 1]) &&
                    (o.setStart(e, t), o.setEnd(e, t + 1), !Gi(o))
                  )
            ...
            if (Mi(r))
              if (e.isAtEnd()) {
                const e = qi(r, s);
                Hi(e) && o(e, e.data.length),
                  zi(e) && !$i(e) && n(Qi(Zi(e), !1));
              } else {
                const a = qi(r, s);
                if ((Hi(a) && o(a, 0), zi(a) && e.isAtEnd()))
                  return n(Qi(Zi(a), !1)), t;
  ...
  (Ji.fromRangeStart = (e) => Ji(e.startContainer, e.startOffset)),
    ...
    (Ji.isAbove = (e, t) =>
      It(le(t.getClientRects()), de(e.getClientRects()), vi).getOr(!1)),
    (Ji.isBelow = (e, t) =>
      It(de(t.getClientRects()), le(e.getClientRects()), yi).getOr(!1)),
  ...
  const el = (e, t) => {
    ...
    al = (e) =>
      e
        ? Be(
            e.childNodes,
            (e, t) => (
              ol(t) && "BR" !== t.nodeName ? (e = e.concat(al(t))) : e.push(t),
              e
            ),
            []
          )
    ...
    bl = (e, t, n) => {
      ...
      const s = ((e) =>
        hl(e.startContainer, e.startOffset) || hl(e.endContainer, e.endOffset))(
        r
      );
      if (s) {
        const e = s.tagName;
  ...
  const _l = (e) => "inline-command" === e.type || "inline-format" === e.type,
    ...
    hu = (e, t, n) => {
      ...
      if (dr(a)) {
        ...
        if (ui(a) && i >= a.data.length - 1)
          return 1 === e && ((o = s(a)), o) ? gu(o) : n;
  ...
  const Eu = vr,
    ...
    Ru = (e) =>
      ...
      ((e) =>
        !!Di(e) &&
        !X(ce(e.getElementsByTagName("*")), (e, t) => e || _i(t), !1))(e),
    Au = Li,
    Tu = (e, t) =>
      e.hasChildNodes() && t < e.childNodes.length ? e.childNodes[t] : null,
    Ou = (e, t) => {
      if (ru(e)) {
        if (Nu(t.previousSibling) && !ku(t.previousSibling))
          return Ji.before(t);
    ...
    Bu = (e, t, n) => {
      ...
      if (t.isEqual(Ji.after(n)) && n.lastChild) {
        if (
          ((a = Ji.after(n.lastChild)),
          su(e) && Nu(n.lastChild) && _u(n.lastChild))
        )
    ...
    Fu = (e, t, n) =>
      Iu(e, t, n).bind((o) =>
        ...
        ((e, t, n) => {
          return e
            ? !Mu(t, n) &&
                ((o = t), !(!Ji.isTextPosition(o) && pr(o.getNode()))) &&
                Lu(t) &&
                Du(n)
            : !Mu(n, t) && Du(t) && Lu(n);
          var o;
    ...
    Uu = (e, t, n, o) =>
      Fu(e, t, n).bind((n) => (o(n) ? Uu(e, t, n, o) : I.some(n))),
    zu = (e, t) => {
    ...
    rm = (e, t) => {
      ((e, t) => {
        ...
        if (t) {
          ...
          if (((e) => ke(e, "rng"))(t))
            return I.some({ range: t.rng, forward: Xu(t) });
        }
        return I.none();
  ...
  const lm = (e) => "" !== e && -1 !== " \f\n\r\t\v".indexOf(e),
    ...
    Zm = (e, t, n, o, r, s) => {
        ...
        l = (t, n, o) => {
          ...
          return I.from(
            l(
              t,
              n,
              (e, t) => ($m(e.parentNode) ? -1 : ((a = e), o(r, e, t))),
              i
            )
          );
        };
      return l(n, o, Gm)
        .bind((e) =>
          s ? l(e.container, e.offset + (r ? -1 : 0), Xm) : I.some(e)
        )
        .orThunk(() =>
    ...
    Jm = (e, t, n, o) => {
      ...
      if (
        (s && Im(i) && i.wrapper && (s = Vm(e, s, "ul,ol").reverse()[0] || s),
        !s)
      )
        for (
          s = n;
          s && s[o] && !e.isBlock(s[o]) && ((s = s[o]), !Om(s, "br"));
    ...
    ef = (e, t, n, o) => {
      ...
      return (
        !C(n[o]) && (!(r !== t && !y(r) && !e.isBlock(r)) || ef(e, t, r, o))
      );
    },
    tf = (e, t, n, o, r) => {
      let s = n;
    ...
    of = (e, t, n, o = !1) => {
      ...
      return (
        ...
        zm(l) &&
          ((r = Qm(e, n, t, r, "previousSibling")),
          (a = Qm(e, n, t, a, "nextSibling"))),
        (Im(l) || Fm(l)) &&
          ...
          Im(l) &&
            ...
            e.isBlock(a) ||
              ((a = tf(e, n, a, i, !1)), dr(a) && (i = a.data.length)))),
  ...
  const mf = (e, t, n) =>
    ...
    Cf = {
      ...
      HOME: 36,
      modifierPressed: (e) =>
        e.shiftKey || e.ctrlKey || e.altKey || Cf.metaKeyPressed(e),
      metaKeyPressed: (e) =>
        ...
        L = (o) => {
          ...
          if (
            ...
            if (D(t, a) && D(e.getEnd(!0), a))
              return n.setAttrib(a, wf, i), void B.throttle(a);
          }
          P();
        },
        M = () => {
  ...
  const Tf = (e, t, n, o) => ({ start: e, soffset: t, finish: n, foffset: o }),
    ...
    Kf = (e, t, n, o, r) => {
      ...
      const u = new Vo(r, c);
      for (; (d = u[o ? "prev" : "next"]()); ) {
        if ("false" === e.getContentEditableParent(d) || qf(d, s))
          return I.none();
        if (dr(d) && d.data.length > 0)
          return Vf(d, s, "A")
            ? I.none()
            : I.some(Ji(d, o ? d.data.length : 0));
  ...
  const og = (e) => "textarea" === $t(e),
    ...
    Ag = (e) =>
      (e.bookmark ? e.bookmark : I.none())
        .bind((t) => {
          return (
            (n = Cn(e.getBody())), (o = t), I.from(o).filter(_g(n)).map(Eg)
          );
          var n, o;
        })
        .bind(Ng),
  ...
  const Pg = fa.DOM,
    ...
    Lg = (e, t) => {
      const n = Pd(e),
        o = Pg.getParent(
          t,
          (t) =>
            ((e) => er(e) && Tg.isEditorUIElement(e))(t) ||
            (!!n && e.dom.is(t, n))
        );
      return null !== o;
    },
    ...
    Fg = (e, t) => {
      e.focusedEditor === t.editor && (e.focusedEditor = null),
        !e.activeEditor &&
          Bg &&
          (Pg.unbind(document, "focusin", Bg), (Bg = null));
    },
    Ug = (e, t) => {
      ((e, t) =>
        ((e) =>
          e.collapsed
            ? I.from(xi(e.startContainer, e.startOffset)).map(Cn)
            : I.none())(t).bind((t) =>
      ...
      e.inline
        ? ((e) => {
            ...
            return (
              ...
              Cg(n) ||
                ((o = n),
                wg(qn(o)).filter((e) => o.dom.contains(e.dom))).isSome())
            );
            var n, o;
          })(e)
  ...
  const wp = ["font", "text-decoration", "text-emphasis"],
    ...
    Np = (e) => {
      ...
      return (
        dr(t) &&
        (0 === t.data.length || (ei(t.data) && uf.isBookmarkNode(t.parentNode)))
      );
    },
    Rp = (e, t) => (n) =>
      cu(e ? 0 : -1, n)
    ...
    Qp = (e, t, n) =>
      ((e) => I.from(e.getNode(!0)).map(Cn))(t).exists(Va) ||
      Xp(!1, e, t, n).isSome(),
    Jp = T(Xp, !1),
    eh = T(Xp, !0),
    ...
    oh = (e, t, n) =>
      th(t) ? Sp(t) : Sp(t) || Hu(nh(e, t, n).dom, t).exists(Sp),
    rh = (e, t, n) =>
      th(t) ? _p(t) : _p(t) || ju(nh(e, t, n).dom, t).exists(_p),
    sh = (e) =>
      yu(e)
        .bind((e) => Jn(e, Kt))
        .exists((e) =>
    ...
    wh = (e) => {
      return Pi(e.previousSibling)
        ? I.some(
            ((t = e.previousSibling),
            dr(t) ? Ji(t, t.data.length) : Ji.after(t))
          )
        : e.previousSibling
        ...
        e
          ? ((e, t) =>
              xh(t)
                ...
                .orThunk(() =>
                  ((e, t) =>
                    ju(e, Ji.after(t)).orThunk(() => Hu(e, Ji.before(t))))(e, t)
                ))(t, n)
          : ((e, t) =>
              wh(t)
                .orThunk(() => xh(t))
    ...
    Th = (e, t, n) => {
      const o = ((e, t, n) => Y(fa.DOM.getParents(n.container(), "*", t), e))(
        e,
        t,
        n
      );
    ...
    Yh = (e, t) =>
      fm(e.start, t).bind((n) => fm(e.end, t).bind((e) => Ft(_n(n, e), n))),
    Gh = (e) => (t) =>
      Yh(t, e).map((e) =>
        ((e, t, n) => ({ rng: e, table: t, cells: n }))(t, e, Hh(e))
      ),
    Xh = (e, t, n, o) => {
    ...
    Zh = (e, t) => J(e, (e) => _n(e, t)),
    Qh = (e) =>
      It(Zh(e.cells, e.rng.start), Zh(e.cells, e.rng.end), (t, n) =>
        e.cells.slice(t, n + 1)
      ),
    Jh = (e, t) => {
            ...
            Xh(e, t, n, o)
              ...
              .bind((e) => {
                ...
                if (o && e.cells.length === r.length)
                  return I.some(qh.fullTable(e.table));
                if (r.length > 0) {
              ...
              n.deleteContents(),
                ((e, t, n) => {
                  n.each((n) => {
                    t
                      ? Eo(n)
                      : (Qa(n), e.selection.setCursorLocation(n.dom, 0));
                  });
          ...
          ((e, t, n, o) => {
            ...
            Ft(
              ((e, t) => {
                ...
                return (
                  ub(t, n) || Iu(t, e.getBody(), n).exists((e) => ub(t, e))
                );
              })(e, t),
              k
            )
              ...
              : ((e, t, n, o) =>
                  db(t, o).fold(
                    () =>
                      ((e, t, n) =>
                        eb(t, n).bind((t) =>
                          t.fold(T(ab, e), T(ib, e), T(rb, e), T(sb, e))
                        ))(e, t, n),
                    (t) => ((e, t) => cb(e, t))(e, t)
                  ))(e, o, r, t);
          })(e, n, o);
    ...
    Db = (e, t, n, o) => {
      ...
      return s
        ? c(1)
          ...
          : c(2)
          ? ((e, t, n, o) => (o.insertAfter(t.reverse(), e), Pb(t[0], n)))(
              s,
              a,
              d,
              t
      ...
      m === f &&
        ...
        s.isCollapsed() ||
          ((e) => {
            ...
            ((e, t, n) =>
              !!C(n) && n === e.getParent(t.endContainer, Mb) && hm(Cn(n), t))(
              t,
              n,
              o
            )
  ...
  const lv = ["fontWeight", "fontStyle", "color", "fontSize", "fontFamily"],
    ...
    uv = (e, t) =>
      !1 ===
      ju(t, Ji.fromRangeEnd(e)).exists(
        (e) => !pr(e.getNode()) || ju(t, e).isSome()
      ),
    ...
    Ov = (e, t, n) => {
      ...
      Im(n) &&
        ...
        (((e) => Fm(e) && Um(e) && Lt(Ee(e, "mixed"), !0))(n) &&
          !_v(n.inline, t)) ||
          s.remove(t, !0);
    },
    Bv = (e, t, n) =>
      x(e) ? { name: t, value: null } : { name: e, value: Tm(t, n) },
    Pv = (e, t) => {
      "" === e.getAttrib(t, "style") &&
    ...
    Dv = (e, t, n, o, r) => {
      ...
      kv(n.styles, (a, i) => {
        const { name: l, value: d } = Bv(i, a, o),
          c = Bm(d, l);
        (n.remove_similar || h(d) || !er(r) || _v(Pm(e, r, l), c)) &&
          e.setStyle(t, l, ""),
          (s = !0);
      }),
        s && Pv(e, t);
    ...
    Lv = (e, t, n, o, r) => {
      ...
      if (!t.ceFalseOverride && o && "false" === s.getContentEditableParent(o))
        return xv.keep();
      if (o && !qb(s, o, t) && !((e, t) => t.links && "A" === e.nodeName)(o, t))
        return xv.keep();
      const l = o,
          ...
          const s = e.formatter.get(t),
              ...
              return ((e, t, n, o, r, s, a, i) => {
                ...
                if (n) {
                  ...
                  for (let n = o.parentNode; n && n !== s; n = n.parentNode) {
                    ...
                    for (
                      let n = 0;
                      n < t.length && ((o = Mv(e, t[n], i, o)), null !== o);
                      n++
                    );
            ...
            m = (e) => {
              ...
              if (t) {
                ...
                return (
                  ((e) =>
                    sm(e) && er(e) && ("_start" === e.id || "_end" === e.id))(
                    n
            ...
            f = (t) => {
              ...
              if (a.split) {
                if (
                  ((r = Zf(r)), (n = Nv(e, r, !0)), (o = Nv(e, r)), n !== o)
                ) {
    ...
    Fv = (e, t, n, o, r) =>
      Lv(e, t, n, o, r).fold(L, (t) => (e.dom.rename(o, t), !0), M),
    Uv = Dt.each,
    zv = Dt.each,
    jv = (e, t, n, o) => {
      if (
        ...
        f = (o, a, i) => {
          ...
          rf(o, a, (a) => {
            ...
            const p = (a) => {
              ...
              if (
                ((o) =>
                  ((e) => Im(e) && !0 === e.wrapper)(s) && Kb(e, o, t, n))(a)
              )
                u = null;
              else {
                if (
                  ...
                  (s.exact ||
                    ...
                    (a = ((e) => {
                      const t = Q(e.childNodes, xm).filter(
                        (e) =>
                          "false" !== o.getContentEditable(e) && qb(o, e, s)
                      );
                      return t
                        .map((t) => {
                          const n = o.clone(t, !1);
  ...
  var oC = (function e() {
    let t =
      arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : nC();
    const n = (t) => e(t);
    if (
      ((n.version = "3.0.5"),
      (n.removed = []),
          ...
          if (
            ...
            (he =
              "ALLOWED_NAMESPACES" in e
                ? By({}, e.ALLOWED_NAMESPACES, Ey)
                : be),
            (de =
              "ADD_URI_SAFE_ATTR" in e
                ? By(Py(ce), e.ADD_URI_SAFE_ATTR, Ce)
                : ce),
            (ie =
              "ADD_DATA_URI_TAGS" in e
                ? By(Py(le), e.ADD_DATA_URI_TAGS, Ce)
                : le),
            ...
            e.FORBID_CONTENTS &&
              (se === ae && (se = Py(se)), By(se, e.FORBID_CONTENTS, Ce)),
            ne && (M["#text"] = !0),
    ...
    const Te = function (e) {
      ...
      Me = function (e) {
        ...
        if (!M[r] || j[r]) {
          if (!j[r] && Fe(r)) {
            if (z.tagNameCheck instanceof RegExp && Ry(z.tagNameCheck, r))
              return !1;
        ...
        return e instanceof d &&
          ...
          ? (K &&
              ...
              (t = _y(t, T, " ")),
              e.textContent !== t &&
                (wy(n.removed, { element: e.cloneNode() }),
                (e.textContent = t))),
      ...
      (n.sanitize = function (e) {
        ...
        if (
          ...
          if ("function" != typeof e.toString)
            throw Ay("toString is not a function");
          if ("string" != typeof (e = e.toString()))
            throw Ay("dirty is not a string, aborting");
        }
  ...
  const gC = (e, t, n, o, r) => {
      ...
      const n = Xv(),
        ...
        p = {
          ...
          parse: (e, n = {}) => {
            ...
            Wr(t, c);
            const m = new ep(d, 11);
            EC(m, c, t.getSpecialElements(), a.sanitizeNamespaceElement),
              (c.innerHTML = "");
            const [f, p] = ((e, t, n, o) => {
                const r = n.validate,
                  s = t.getNonEmptyElements(),
    ...
    _C = (e, t, n) => {
      ...
      if (Fb(e)) {
        if (r.content !== o) {
          const t = kC({ validate: !1, forced_root_block: !1, ...n }).parse(
            r.content,
            { context: e.name }
          );
          return { ...r, content: t };
    ...
    ow = (e) => ({
      ...
      undoManager: {
        ...
        hasUndo: (t, n) =>
          ((e, t, n) =>
            n.get() > 0 || (t.typing && t.data[0] && !JC(GC(e), t.data[0])))(
            e,
            t,
            n
          ),
        ...
        transact: (e, t, n) =>
          ((e, t, n) => (nw(e, t), e.beforeChange(), e.ignore(n), e.add()))(
            e,
            t,
            n
          ),
        ...
        getContent: (t) =>
          ((e, t) =>
            I.from(e.getBody()).fold(
              N("tree" === t.format ? new ep("body", 11) : ""),
              (n) => hp(e, t, n)
            ))(e, t),
        setContent: (t, n) =>
          ((e, t, n) =>
                  ...
                  return ((e) =>
                    I.from(e.selection.getRng())
                      .map((t) => {
                        ...
                        if (
                          (e.dom.remove(i), VC(d, 0) || VC(d, d.length - 1))
                        ) {
                          const e = o.getOr(r),
                            t = qC(e),
                            n = t.indexOf(l);
    ...
    dw = (e, t, n, o, r) => {
      e.bind(
        ...
        const e = ((e, t) =>
          e.filter((e) => uf.isBookmarkNode(e.dom)).bind(t ? Dn : Pn))(t, o)
          .or(t)
          .filter(Yt);
        return e.map((e) =>
          ((e, t, n) => {
  ...
  const uw = (e) => !(!e || !e.ownerDocument) && Sn(Cn(e.ownerDocument), Cn(e)),
      ...
      const { selectorChangedWithUnbind: a } = ((e, t) => {
        ...
        c = () => {
          ...
          if (C(o.bookmark) && !jg(o)) {
            const e = Ag(o);
            if (e.isSome())
              return e.map((e) => Gg(o, [e])[0]).getOr(i.createRange());
          }
          try {
            const e = d();
            e &&
        ...
        u = (e, t) => {
          if (!((e) => !!e && uw(e.startContainer) && uw(e.endContainer))(e))
            return;
          const n = d();
          if (
        ...
        f = {
          ...
          getContent: (e) =>
            ((e, t = {}) =>
              ((e, t, n) => aw(e).selection.getContent(t, n))(
                e,
    ...
    hw = (e, t, n = {}) => {
      ...
      return AC(e, o)
        .map((t) => {
          const n = ((e, t, n) => sw(e).editor.setContent(t, n))(
            e,
            t.content,
            t
          );
                    ...
                    return C(s)
                      ...
                      : ((o = t),
                        $e(o, "blob:")
                          ...
                          ey(t).then((o) =>
                            ny(o, !1, (n) => I.some(oy(e, t, n))).getOrThunk(n)
                          )
                        );
                  }
                  var o, r;
  ...
  const Qw = (e, t) => {
                      ...
                      n.status && td(e)
                        ...
                        : n.error &&
                          ...
                          ((e, t) => {
                            $w(
                              e,
                              ya.translate(["Failed to upload image: {0}", t])
                            );
                          })(e, n.error.message)),
                      {
                        element: l,
    ...
    mx = (e) => {
      ...
      return (
          ...
          })(n, e),
        {
          ...
          match: (t, n, o, r) =>
            ((e, t, n, o, r) => aw(e).formatter.match(t, n, o, r))(
              e,
              t,
              n,
              o,
          ...
          matchAll: (t, n) =>
            ((e, t, n) => aw(e).formatter.matchAll(t, n))(e, t, n),
          matchNode: (t, n, o, r) =>
            ((e, t, n, o, r) => aw(e).formatter.matchNode(t, n, o, r))(
              e,
              t,
              n,
              o,
          ...
          formatChanged: (t, o, r, s) =>
            ((e, t, n, o, r, s) =>
              aw(e).formatter.formatChanged(t, n, o, r, s))(e, n, t, o, r, s),
          getCssText: T(ux, e),
        }
      );
    },
    ...
    gx = (e) => {
      const t = Dr(),
        ...
        r = {
          ...
          add: (s, a) =>
            ((e, t, n, o, r, s, a) => aw(e).undoManager.add(t, n, o, r, s, a))(
              e,
              r,
              o,
              n,
          ...
          undo: () =>
            ((e, t, n, o) => aw(e).undoManager.undo(t, n, o))(e, r, n, o),
          ...
          hasUndo: () =>
            ((e, t, n) => aw(e).undoManager.hasUndo(t, n))(e, r, o),
          hasRedo: () =>
            ((e, t, n) => aw(e).undoManager.hasRedo(t, n))(e, r, o),
          transact: (t) =>
            ((e, t, n, o) => aw(e).undoManager.transact(t, n, o))(e, r, n, t),
          ignore: (t) => {
            ((e, t, n) => {
            ...
            e.on("init", () => {
              ...
              e.on("keydown", (e) => {
                ...
                if (
                  ...
                  return (
                    t.beforeChange(), tw(t, !0, n), t.add({}, e), void o.set(!0)
                  );
    ...
    Ox = (e) => {
      ...
      return ((e, t) => {
        ...
        return (
          !((e, t) => Tx(e, t.startContainer) || Tx(e, t.endContainer))(e, t) &&
          n &&
          o
        );
        ...
        : ((e, t, n) => {
            const o = t.getRng();
            return It(
              Ih(e, Cn(o.startContainer)),
              Ih(e, Cn(o.endContainer)),
              (r, s) =>
                _n(r, s)
                  ? I.none()
                  : I.some(() => {
    ...
    $x = (e, t, n, o) =>
      Iu(t, e, n).bind((r) => {
        return (
          ...
          ((e, t, n, o, r) => {
            const s = (t) =>
              r.isInline(t.nodeName.toLowerCase()) && !du(n, o, e);
            ...
            ? ((e, t, n, o, r) => {
                ...
                return Ih(Cn(t), Cn(o.getNode()))
                  .map((t) =>
                    Tr(e, t) ? Hx.remove(t.dom) : Hx.moveToElement(s)
                  )
      ...
      e
        ? ((e) => {
            ...
            if (Gx(e.previousSibling))
              return (
                Zx(e.previousSibling) || e.previousSibling.appendData(Ja),
                e.previousSibling
              );
        ...
        : ((e) => {
            ...
            if (Gx(e.nextSibling))
              return (
                Xx(e.nextSibling) || e.nextSibling.insertData(0, Ja),
                e.nextSibling
              );
    ...
    tE = T(Jx, !1),
    nE = (e, t) =>
      dr(e.container()) ? Jx(t, e.container()) : Jx(t, e.getNode()),
    oE = (e, t) => {
      const n = t.get();
    ...
    uE = (e, t, n) => {
      const o = Ph(n);
      return cE(e, t, o).bind((e) =>
        Hu(e, o).isNone() ? I.some(aE.start(e)) : I.none()
      );
    },
    mE = (e, t, n) => {
      const o = Bh(n);
      return cE(e, t, o).bind((e) =>
        ju(e, o).isNone() ? I.some(aE.end(e)) : I.none()
      );
    },
    fE = (e, t, n) => {
      const o = Ph(n),
  ...
  const KE = (e, t, n, o, r, s) => {
    ...
    hk = (e, t, n, o) => {
      ...
      e.undoManager.ignore(() => {
        e.selection.setRng(
          ...
          Lh(e),
          pE(s, r, Ji.fromRangeStart(e.selection.getRng()))
            .map(yE)
            .bind(pk(e, t))
            .each(D);
      }),
    ...
    xk = (e, t) => {
      const n = Y(
        ((e) => vk(e, (t) => e.schema.isBlock($t(t)) || ((e) => jn(e) > 1)(t)))(
          e
        ),
        yk
      );
    ...
    Fk = (e, t, n) =>
      ue([Ik, Kx, Ux, (e, n) => bk(e, t, n), Ax, fb, Yx, Ak, Bx, Sk], (t) =>
        t(e, n)
    ...
    Hk = (e, t) =>
      !!dr(t) ||
      (!!er(t) && !(jk(e.getBlockElements(), t) || sm(t) || Zr(e, t) || Ir(t))),
    $k = (e, t) => {
      if (dr(t)) {
    ...
    h_ = (e, t, n) =>
      te(In(e), (e) => (En(e, t) ? (n(e) ? [e] : []) : h_(e, t, n))),
    b_ = (e, t) => oo(e, "table", t),
    v_ = (e, t, n, o, r = M) => {
      const s = 1 === o;
    ...
    __ = (e, t, n) => {
      ...
      return ((e) => e.breakType === kE.Wrap && 0 === e.positions.length)(o) ||
        (!pr(n.getNode()) &&
          ((e) => e.breakType === kE.Br && 1 === e.positions.length)(o))
      ...
      if (t && N_(o, s)) {
        const o = ((e, t, n) =>
          ((e, t) =>
            ...
            .orThunk(() =>
              le(n.getClientRects()).bind((n) => TE(LE(e, Ji.after(t)), n.left))
            )
    ...
    $_ = (e, t, n) => {
      ...
      {
        const r = za(U_);
        return I.from(r.forwards(e, t, z_(e), n)).bind((e) =>
          $_(e.container, t - o.length, n)
        );
      }
    },
    V_ = (e, t, n, o, r) => {
    ...
    K_ = (e, t, n, o = !1) => {
      ...
      return V_(
        ...
        return 0 !== r.lastIndexOf(n)
          ? I.none()
          : I.some({ text: W_(r, n), range: o, trigger: n });
      });
    },
    Y_ = (e) => {
          ...
          e.fold(
            ...
            (e) => {
              ...
              return (
                ...
                (a = I.some),
                s.stype === Z_.Value
                  ? { stype: Z_.Value, svalue: a(s.svalue) }
                  : s
              );
              var s, a;
            }
    ...
    hS = (e, t, n) => {
      return (
        (o = ((e, t, n) =>
          ((e, t) =>
            e.stype === Z_.Error
              ? { stype: Z_.Error, serror: t(e.serror) }
  ...
  gS(
    [
      ...
      LS("initValue", N("")),
      $S,
      ((e, t) => kS(e, e, { tag: "required", process: {} }, pS(t)))(
        "commands",
        oN
      ),
      AS(
        "launch",
        bS("type", { contextformbutton: tN, contextformtogglebutton: nN })
      ),
    ].concat(QS)
  );
  const rN = (e) => {
        ...
        a = (a) => {
          ((n) =>
            t
              .get()
              .map((t) =>
                K_(e.dom, e.selection.getRng(), t.trigger, !0).bind((t) =>
                  X_(e, s, t, n)
                )
              )
              .getOrThunk(() =>
                ((e, t) => {
                  const n = t(),
                    o = e.selection.getRng();
                  return ((e, t, n) => ue(n.triggers, (n) => K_(e, t, n)))(
                    e.dom,
                    o,
                    n
                  ).bind((n) => X_(e, t, n));
      ...
      if ("character" === n) {
        ...
        return (
          !!(
            l &&
            (t ? c : d) &&
            Fu(!t, s, n).exists((e) => cN(o, e) && !Mt(i, dN(o, e)))
          ) ||
          Fu(t, s, n).fold(L, (n) => {
            const r = dN(o, n);
            if (cN(o, n) && !Mt(i, r)) {
        ...
        ? ((e, t) =>
            t.startSummary.exists((t) =>
              ((e, t) =>
                Vu(t).exists(
                  (n) =>
                    (pr(n.getNode()) && Hu(t, n).exists((t) => t.isEqual(e))) ||
                    n.isEqual(e)
                ))(e, t)
            ))(s, t) ||
          ((e, t, n) =>
            n.startDetails.exists((n) =>
              ju(e, t).forall((e) => !n.contains(e.container()))
            ))(a, s, t)
        : ((e, t) =>
            t.startSummary.exists((t) =>
              ((e, t) => $u(t).exists((t) => t.isEqual(e)))(e, t)
            ))(s, t) ||
          ((e, t) =>
    ...
    QN = (e, t) => (n, o) => {
      const r =
        ((e) => _N(e).fold(N(""), (e) => e.nodeName.toUpperCase()))(n) ===
        e.toUpperCase();
      return r === t;
    },
    JN = (e) => {
    ...
    pR = (e, t, n) => {
      n && !e.get()
        ? t.on("NodeChange", fR, !0)
        : !n && e.get() && t.off("NodeChange", fR),
        e.set(n);
    },
    hR = (e, t) => {
      const n = t.container(),
    ...
    xR = (e) =>
      _c(e)
        ...
        : [],
    ER = (e) => {
      if ((e.addShortcut("Meta+P", "", "mcePrint"), sN(e), rw(e)))
        return Br(null);
      {
        const t = uk(e);
        return (
          ((e) => {
            e.on("beforeinput", (t) => {
              (e.selection.isEditable() &&
                !$(t.getTargetRanges(), (t) => !Vg(e.dom, t))) ||
                t.preventDefault();
            });
          })(e),
          ((e) => {
                ...
                o.isDefaultPrevented() ||
                  ((e, t, n) => {
                    ...
                    c_(
                      ...
                      .each((t) => {
                        n.preventDefault(),
                          vN(e, o).isDefaultPrevented() || (t(), bN(e, o));
                      });
                  })(e, t, o);
            }),
              e.on("keyup", (t) => {
  ...
  const BR = La("mode"),
    ...
    aA = (e, t, n) =>
      !!((e, t) =>
        rA(t) && $(kc(e), (e) => Ve(t.toLowerCase(), `.${e.toLowerCase()}`)))(
        e,
        t
      ) &&
      ((e, t, n) => (
    ...
    dA = (e, t, n, o, r) => {
      ...
      if (!s.cancelled) {
        ...
        r
          ? vN(e, "insertFromPaste", {
              dataTransfer: lA(t),
            }).isDefaultPrevented() || (n(), bN(e, "insertFromPaste"))
          : n();
      }
    },
    cA = (e, t, n, o) => {
      ...
      if (rc(e) && o) {
        ...
        if (s.length > 0)
          return (
            ...
            ((r = s),
            Promise.all(
              V(r, (e) => ey(e).then((t) => ({ file: e, uri: t })))
            )).then((t) => {
    ...
    bA = (e, t, n) => {
      ((e, t, n) => {
        ...
        e.on("keydown", (e) => {
          ((e) =>
            (Cf.metaKeyPressed(e) && 86 === e.keyCode) ||
        ...
        ((e, t) => {
          e.addCommand("mceTogglePlainTextPaste", () => {
            ...
            e.addCommand("mceInsertClipboardContent", (t, n) => {
              n.html && cA(e, n.html, n.internal, !1),
                n.text && uA(e, n.text, !1);
            });
        })(e, n),
        ((e) => {
          const t = (t) => (n) => {
  ...
  const MA = (e, t) => Math.abs(e.left - t),
    ...
    VA = (e, t, n, o) => {
      ...
      return v(o)
        ...
        : ((e, t, n, o) => ({ ...t, dataTransfer: o, type: e, ...$A(n) }))(
            e,
            o,
            t,
            r
            ...
            const s = r.currentTarget === t.getDoc().documentElement,
              l = ((e, t) => ({ pageX: t.pageX - e.relX, pageY: t.pageY + 5 }))(
                ...
                ((e, t) => {
                  return (
                    (n = ((e) =>
                      e.inline ? HA(e.getBody()) : { left: 0, top: 0 })(e)),
                    (o = ((e) => {
                      const t = e.getBody();
                      return e.inline
                ...
                eT(t, "drop", r, e.dataTransfer, n).isDefaultPrevented() ||
                  t.undoManager.transact(() => {
                    ((e, t) => {
                      ...
                      JA(t),
                        n && n !== e.getRoot() && e.isEmpty(n) && Qa(Cn(n));
                    })(t.dom, e.element),
                      ((e) => {
                  ...
                  const t = (t) => {
                      if (!t.isDefaultPrevented()) {
                        ...
                        n &&
                          ...
                          (t.preventDefault(),
                          "drop" === t.type &&
                            $w(e, "Dropped file type is not supported"));
                      }
                    },
                    n = (n) => {
                      Lg(e, n.target) && t(n);
    ...
    AT = (e, t, n) =>
      ((e, t, n) => {
        ...
        {
          const t = za(U_);
          return I.from(t.forwards(e, 0, z_(e), n)).map((e) =>
            F_(e.container, 0)
          );
        }
      })(t, 0, t).map((o) => {
    ...
    zT = (e) => {
      ...
      e.on("keyup", (e) => {
        ...
        e.on("keypress", (n) => {
          UT(t, n, (e, t) => e.charCodeAt(0) === t.charCode) &&
            Og.setEditorTimeout(e, s);
        });
    },
    jT = (e) => {
      const t = Dt.each,
      ...
      const a = Promise.all(
          ((e, t, n) => {
            const { pass: o, fail: r } = K(t, (e) =>
                tinymce.Resource.has(Kw(e))
              ),
              s = o.map((t) => {
                const n = tinymce.Resource.get(Kw(t));
                return m(n)
                  ? Promise.resolve(KT(e).loadRawCss(t, n))
                  : Promise.resolve();
              }),
              a = [...s, KT(e).loadAll(r)];
    ...
    XT = (e) => {
            ...
            s = (t, a) => {
              ...
              const i = e.getBody(),
                l =
                  !((e) =>
                    bx(e) &&
                    !(vx(e) || ("keyup" === e.type && 229 === e.keyCode)))(t) &&
                  ((e, t, n) => {
                    if (
      ...
      ((e) => {
        ...
        ((e) => {
          ...
          tc(e) ||
            ((t.body.spellcheck = !1), HT.setAttrib(n, "spellcheck", "false")),
          (e.quirks = jT(e)),
          ((e) => {
          ...
          if (m(t)) {
            ...
            (e.theme = n(e, zw.urls[t]) || {}),
              w(e.theme.init) &&
                e.theme.init(
                  e,
                  zw.urls[t] || e.documentBaseUrl.replace(/\/$/, "")
                );
          } else e.theme = {};
        })(e),
        ((e) => {
            ...
            ((e, t, n) => {
              ...
              if (((n = Dt.trim(n)), o && -1 === Dt.inArray(t, n))) {
                ...
                try {
                  ...
                  ((e, t, n) => {
                    const o = ya.translate([
                      "Failed to initialize plugin: {0}",
                      t,
                    ]);
                    ff(e, "PluginLoadError", { message: o }),
                      Ww(o, n),
                      $w(e, o);
                  })(e, n, t);
                }
    ...
    vO = (e, t) => {
      if (e.selection.isEditable()) {
        ...
        AC(e, {
          ...
          const n = ((e, t, n) => sw(e).editor.insertContent(t, n))(
            e,
            t.content,
            o
          );
          ...
          ((e, t, n) =>
            jb(
              ...
              (t) =>
                ((t) =>
                  fo(t, e).orThunk(() =>
                    CO(t) ? Ee(yO, e).bind((e) => nn(t, e)) : I.none()
                  ))(t),
              (e) => _n(Cn(t), e)
            ))(e, t, n.dom).or(
            ((e, t) => I.from(fa.DOM.getStyle(t, e, !0)))(e, n.dom)
          )
        )
        .getOr(""),
    xO = wO("font-size"),
          ...
          ((e) => {
            ...
            e.editorCommands.addCommands({
              ...
              FontName: (t, n, o) => {
                ((e, t) => {
                  const n = SO(e, t);
                  e.formatter.toggle("fontname", { value: NO(n) }),
                    e.nodeChanged();
                })(e, o);
              },
              FontSize: (t, n, o) => {
                ((e, t) => {
                  e.formatter.toggle("fontsize", { value: SO(e, t) }),
                    e.nodeChanged();
                })(e, o);
              },
              LineHeight: (t, n, o) => {
                  ...
                  (t
                    ...
                    : ((e) => {
                        ...
                        if (r && e.dom.isChildOf(r, n))
                          return zg(r), Ug(e, o), void $g(e);
                        e.inline ||
                          (Tt.browser.isOpera() || zg(n), e.getWin().focus()),
  ...
  class BO {
    ...
    queryCommandState(e) {
      if ((!OO(e) && this.editor.quirks.isHidden()) || this.editor.removed)
        return !1;
      const t = e.toLowerCase(),
  ...
  const PO = "data-mce-contenteditable",
    ...
    IO = (e) => {
      e.parser.addAttributeFilter("contenteditable", (t) => {
        MO(e) &&
          q(t, (e) => {
            e.attr(PO, e.attr("contenteditable")),
  ...
  const qO = (e, t) => {
      ...
      const n = xd(e);
      return n
        ? (e.eventRoot || (e.eventRoot = $O.select(n)[0]), e.eventRoot)
        : e.getBody();
    },
    WO = (e, t, n) => {
      ((e) => !e.hidden && !MO(e))(e)
  ...
  class uB {
    constructor(e, t, n) {
        ...
        const n = {},
          ...
          r = (e, t, n) => {
            ...
            return ZO(r)
              ? ((o[e] = r.value), !0)
              : (console.warn(
                  XO(`Invalid value passed for the ${e} option`, r)
                ),
                !1);
          },
          s = (e) => ke(n, e);
            ...
            const a = ((e) => m(e.processor))(s)
              ...
              i = ((e, t, n) => {
                if (!v(t)) {
                  ...
                  console.error(
                    XO(`Invalid default value passed for the "${e}" option`, o)
                  );
                }
              })(e, s.default, a);
      ...
      const l = dd(o);
      l &&
        (pa.ScriptLoader._setReferrerPolicy(l),
        fa.DOM.styleSheetLoader._setReferrerPolicy(l));
      const d = $d(o);
      ...
      ((e) => {
        ...
        e.on("remove", () => {
          ...
          (e.ui.styleSheetLoader = ((e, t) =>
            rs.forElement(e, { contentCssCors: $d(t), referrerPolicy: dd(t) }))(
            o,
            e
          )),
          Dd(e)
    ...
    hide() {
      ...
      e.hidden ||
        ...
        e.inline
          ...
          : (lB.hide(e.getContainer()),
            lB.setStyle(e.id, "display", e.orgDisplay)),
        (e.hidden = !0),
        e.dispatch("hide"));
    }
    isHidden() {
    ...
    resetContent(e) {
      void 0 === e
        ? hw(this, this.startContent, { format: "raw" })
        : hw(this, e),
    ...
    getContainer() {
      ...
      return (
        e.container ||
          (e.container = e.editorContainer || lB.get(e.id + "_parent")),
        e.container
      );
    }
    ...
    getElement() {
      return (
        this.targetElm || (this.targetElm = lB.get(this.id)), this.targetElm
      );
    }
    getWin() {
      const e = this;
  ...
  const bB = (e) => {
    ...
    yB = (e) => {
      ...
      return (
        (hB = Y(hB, (t) => e !== t)),
        wB.activeEditor === e &&
          (wB.activeEditor = hB.length > 0 ? hB[0] : null),
    ...
    wB = {
            ...
            return (
              ...
              h(t.get(n.id))
                ...
                : (yB(n) && t.dispatch("RemoveEditor", { editor: n }),
                  0 === hB.length &&
                    window.removeEventListener("beforeunload", gB),
                  n.remove(),
                  vB(hB.length > 0),
                  n)
            );
      ...
      _setBaseUrl(e) {
        (this.baseURL = new cC(this.documentBaseURL).toAbsolute(
          e.replace(/\/+$/, "")
        )),
...
!(function () {
  ...
  function G(e) {
    return function () {
      ...
      var n,
        t = (
          ((t = e).currentStyle || window.getComputedStyle(t, null))[n] || ""
        ).toLowerCase();
  ...
  function j(n, t) {
    R(t, ".tox-notifications-container", "block"),
      C(n, "6.0.0") && R(t, ".tox-notification", "-ms-grid"),
      R(t, ".tox-notification", "grid"),
      R(t, ".mce-notification", "block");
  }
  function V(n) {
    var t = n,
    ...
    if (t)
      for (var r = 0; r < e.length; r++)
        e[r].isRequired(t) && e[r].applyPatch(t);
  }
  var z = {
      some: v,
      none: d,
    ...
    $ = function (n, t, e, r, o) {
      var i = m(),
        u = setInterval(function () {
          n() && (clearInterval(u), t()),
            m() - i > o && (clearInterval(u), e());
        }, r);
    },
    J = function (n, t) {
      ((e = document.createElement("div")).style.display = "none"),
        (e.className = "mce-floatpanel");
      var e,
        r = e;
            ...
            (t = c),
              ...
              null === P &&
                ((n = window.fetch(r, {
                  method: "GET",
                  mode: "cors",
                  headers: new window.Headers({ Accept: "application/json" }),
                })),
                (P = n.then(function (r) {
                  ...
                  I(
                    t,
                    'Error in TinyMCE cloud startup, url "'
                      .concat(r, '" returned ')
                      .concat(n.status, ', saying "')
                      .concat(n.statusText, '"')
                  );
                })),
              P.then(function (n) {
      ...
      b(n, function (n) {
        ...
        "none" === window.getComputedStyle(n).display &&
          ...
          (n = r).theme &&
            ...
            a(n.theme.getNotificationManagerImpl) &&
              a(n.theme.getNotificationManagerImpl().reposition) &&
              n.theme.getNotificationManagerImpl().reposition(e),
            b(e, function (n) {
...
tinymce.baseURL = "https://cdn.tiny.cloud/1/no-api-key/tinymce/7.1.0-49";
